...
for no_of_hidden_units in no_of_hidden_units_list:
    # model = RNN_model(vocab_size,no_of_hidden_units)
    ...
    for epoch in range(no_of_epochs):
        ...
        with open('RNN_test_results','a') as f:
            print('sequence length: {}, test accuracy: {}, test loss: {}, elapsed time: {}'.format(sequence_length,epoch_acc,epoch_loss,time_elapsed),file=f)
