...
train_directory = './NLP/aclImdb/train/'
...
test_directory = './NLP/aclImdb/test/'
...
print('saved training data to single text file')
...
print('saved test data to single text file')

# only the first 100k tokens in glove are kept
glove_filename = './NLP/glove.840B.300d.txt'
...
print('saved imdb_train_glove data to single text file')
...
print('saved imdb_test_glove data to single text file')
